...
class OddsGroup(models.Model):
    ...
    over_price = models.IntegerField(null=True)
    under = models.OneToOneField(Odds, on_delete=models.CASCADE, related_name='under', null=True)
    under_price = models.IntegerField(null=True)
    event = models.ForeignKey(Event, null=True, on_delete=models.CASCADE, related_name="groups")
